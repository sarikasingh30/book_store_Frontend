...
const Wishlist = () => {
  ...
  const fetchWishlist = useCallback(async () => {
    const res = await axios.get(`https://book-store-t37x.onrender.com/cw/${userId}/wishlist`);
  ...
  const removeItem = async (val) => {
    await axios.delete(`https://book-store-t37x.onrender.com/cw/${userId}/wishlist`, {
      data: { bookId: val },
    });
